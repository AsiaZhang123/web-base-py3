...
member = MFBlueprint('member', __name__, default_methods=DEFAULT_METHODS, url_prefix='/member')
user_bp = MFBlueprint('user', __name__, default_methods=DEFAULT_METHODS, url_prefix='/member/user')
resume_bp = MFBlueprint('resume', __name__, default_methods=DEFAULT_METHODS, url_prefix='/member/resume')
